...
public class Constants {
    ...
    public static String KEY_ID_AKUN = "idakun";
    public static String KEY_ID_GOOGLE = "idgoogle";
    public static String KEY_ID_PROFIL = "idprofil";
    public static String KEY_ID_ALAMAT = "idalamat";
    public static String KEY_PASSWORD = "password";
    public static String KEY_NAMA_DEPAN = "namadepan";
