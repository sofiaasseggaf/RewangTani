...
public class DatumProduk implements Parcelable
{
    ...
    public final static Creator<DatumProduk> CREATOR = new Creator<DatumProduk>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DatumProduk createFromParcel(android.os.Parcel in) {
            return new DatumProduk(in);
        }

        public DatumProduk[] newArray(int size) {
            return (new DatumProduk[size]);
        }

    }
    ;

    protected DatumProduk(android.os.Parcel in) {
     ...
     * @param idProfil
     */
    public DatumProduk(String createdBy, String createdDate, String updatedBy, String updatedDate, String idProduk, String idTipeProduk, String idProfil, Integer hargaProduk, String foto, String kota, Integer jmlProduk, Integer jmlTerjual) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DatumProduk.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdBy");
        sb.append('=');
