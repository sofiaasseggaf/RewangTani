...
public class DatumObat implements Parcelable
{
    ...
    public final static Creator<DatumObat> CREATOR = new Creator<DatumObat>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DatumObat createFromParcel(android.os.Parcel in) {
            return new DatumObat(in);
        }

        public DatumObat[] newArray(int size) {
            return (new DatumObat[size]);
        }

    }
    ;

    protected DatumObat(android.os.Parcel in) {
     ...
     * @param kandunganObat
     */
    public DatumObat(String createdBy, String createdDate, String updatedBy, String updatedDate, String idObat, String idSubkategori, String namaObat, String kandunganObat, String kegunaanObat, String produsenObat, String ketObat) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DatumObat.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdBy");
        sb.append('=');
