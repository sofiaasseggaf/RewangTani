...
public class DatumProfil implements Parcelable
{
    ...
    public final static Creator<DatumProfil> CREATOR = new Creator<DatumProfil>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DatumProfil createFromParcel(android.os.Parcel in) {
            return new DatumProfil(in);
        }

        public DatumProfil[] newArray(int size) {
            return (new DatumProfil[size]);
        }

    }
    ;

    protected DatumProfil(android.os.Parcel in) {
     ...
     */
    public DatumProfil(String createdBy, String createdDate, String updatedBy, String updatedDate, String idProfile, String idAkun, String namaDepan, String namaBelakang, String alamat, String idAlamat, String nik, String tglLahir, String gender, String telepon, String foto, String idStatusPekerja) {
        super();
    ...
    public String toString() {
        ...
        sb.append(DatumProfil.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdBy");
        sb.append('=');
