...
public class AdapterListWarungTenagaKerjaMonitor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumTenagaKerja> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungTenagaKerjaMonitor(List<DatumTenagaKerja> dataItemList) {
