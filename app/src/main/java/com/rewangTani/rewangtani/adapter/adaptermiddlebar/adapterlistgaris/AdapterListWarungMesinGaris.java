...
public class AdapterListWarungMesinGaris extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumSewaMesin> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungMesinGaris(List<DatumSewaMesin> dataItemList) {
