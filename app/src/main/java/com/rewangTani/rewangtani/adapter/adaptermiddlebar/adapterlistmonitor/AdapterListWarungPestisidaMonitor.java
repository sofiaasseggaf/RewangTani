...
public class AdapterListWarungPestisidaMonitor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumPupukPestisida> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungPestisidaMonitor(List<DatumPupukPestisida> dataItemList) {
