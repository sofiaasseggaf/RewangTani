...
public class AdapterListWarungTenagaKerja extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumTenagaKerja> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungTenagaKerja(List<DatumTenagaKerja> dataItemList) {
