...
public class AdapterListWarungMesinMonitor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumSewaMesin> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungMesinMonitor(List<DatumSewaMesin> dataItemList) {
