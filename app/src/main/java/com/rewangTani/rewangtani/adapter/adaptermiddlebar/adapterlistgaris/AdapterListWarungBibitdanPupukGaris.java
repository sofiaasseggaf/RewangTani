...
public class AdapterListWarungBibitdanPupukGaris extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumPupukPestisida> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungBibitdanPupukGaris(List<DatumPupukPestisida> dataItemList) {
