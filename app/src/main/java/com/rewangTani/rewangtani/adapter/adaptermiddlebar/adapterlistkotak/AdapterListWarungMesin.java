...
public class AdapterListWarungMesin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DatumSewaMesin> dataItemList;
    DecimalFormat formatter;

    public AdapterListWarungMesin(List<DatumSewaMesin> dataItemList) {
