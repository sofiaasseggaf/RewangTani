...
//                checkUsername();
        ...
        binding.btnSignupWithGoogle.setOnClickListener(v -> {
            Toast.makeText(RegisterActivity.this, "Fitur sedang dalam perbaikan", Toast.LENGTH_SHORT).show();
//            signOutGoogle();
...
//                    getToken();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            binding.viewLoading.setVisibility(View.GONE);
                            Toast.makeText(RegisterActivity.this, "Data akun tidak ditemukan", Toast.LENGTH_SHORT).show();
            ...
            for (int i = 0; i < modelAkunAwal.getTotalData(); i++) {
                if (modelAkunAwal.getData().get(i).getEmail().equalsIgnoreCase(googleemail)) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            binding.viewLoading.setVisibility(View.GONE);
                            Toast.makeText(RegisterActivity.this, "Email sudah terpakai", Toast.LENGTH_LONG).show();
                            firebaseAuth = FirebaseAuth.getInstance();
                ...
                public void run() {
                    ...
                    btnDaftar.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (check != 10) {
                                Toast.makeText(RegisterActivity.this, "Centang kebijakan privasi terlebih dahulu", Toast.LENGTH_SHORT).show();
                            } else if (check == 10) {
                                mGoogleSignInClient.signOut();
                                popupWindow.dismiss();
...
//                                    }).start();
                        ...
                        Toast.makeText(RegisterActivity.this, "Password harus kombinasi angka dan huruf", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(RegisterActivity.this, "Password kurang dari 8 karakter", Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        if (dataAkun != null) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    binding.viewLoading.setVisibility(View.GONE);
                                    Toast.makeText(RegisterActivity.this, "Data akun tidak ditemukan", Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    } catch (Exception e) {
                            ...
                            if (modelProfilAkun.getData().get(i).getIdAkun().equalsIgnoreCase(idAkun)) {
                                ...
                                if (dataProfil != null) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            binding.viewLoading.setVisibility(View.GONE);
                                            Toast.makeText(RegisterActivity.this, "Data profil tidak ditemukan", Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }
    ...
    public void goToHome() {
        Intent a = new Intent(RegisterActivity.this, Home.class);
        startActivity(a);
        finish();
    }
