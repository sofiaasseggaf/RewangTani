...
public class DetailWarungSewaMesin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnPesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    chatUtils.goToInbox(idProfile, modelProfilById.getData().getIdProfile(), modelProfilById.getData().getNamaDepan(), dataSewaMesinById.getData().getNamaProduk());
                }
            }
        });
        ...
        binding.btnBeliLangsung.setOnClickListener( v -> {
            ...
            a.putExtra("Harga", String.valueOf(dataSewaMesinById.getData().getHargaProduk()));
            startActivity(a);
        } );
    }
    ...
    public void setData(){
        ...
        if (dataSewaMesinById.getData().getJmlTerjual() == null){
            ...
            binding.terjualWarung.setText("Terpakai : " + dataSewaMesinById.getData().getJmlTerjual() + " kali");
        }
