...
public class DetailWarungPestisida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnPesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    chatUtils.goToInbox(idProfile, modelProfilById.getData().getIdProfile(), modelProfilById.getData().getNamaDepan(), dataBppById.getData().getNamaProduk());
                }
            }
        });
        ...
        binding.btnBeliLangsung.setOnClickListener( v -> {
            ...
            a.putExtra("Harga", String.valueOf(dataBppById.getData().getHargaProduk()));
            startActivity(a);
        } );
    ...
    public void getPestisida(String id) {
...
/*                                try {
    ...
    private void goToChat() {
        Intent a = new Intent(DetailWarungPestisida.this, Chat.class);
        startActivity(a);
        finish();
    }
