...
@Entity(tableName = "warung_tenaga_kerja")
public class DatumTenagaKerja implements Parcelable
{
    ...
    public final static Creator<DatumTenagaKerja> CREATOR = new Creator<DatumTenagaKerja>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DatumTenagaKerja createFromParcel(android.os.Parcel in) {
            return new DatumTenagaKerja(in);
        }

        public DatumTenagaKerja[] newArray(int size) {
            return (new DatumTenagaKerja[size]);
        }

    }
    ;

    protected DatumTenagaKerja(android.os.Parcel in) {
    ...
    public String toString() {
        ...
        sb.append(DatumTenagaKerja.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdBy");
        sb.append('=');
