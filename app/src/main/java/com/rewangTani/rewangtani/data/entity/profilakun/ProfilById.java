...
public class ProfilById implements Parcelable
{
    ...
    public final static Creator<ProfilById> CREATOR = new Creator<ProfilById>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ProfilById createFromParcel(android.os.Parcel in) {
            return new ProfilById(in);
        }

        public ProfilById[] newArray(int size) {
            return (new ProfilById[size]);
        }

    }
    ;

    protected ProfilById(android.os.Parcel in) {
     ...
     */
    public ProfilById(String createdBy, String createdDate, String updatedBy, String updatedDate, String idProfile, String idAkun, String namaDepan, String namaBelakang, String alamat, String idAlamat, String nik, String tglLahir, String gender, String telepon, String foto, String idStatusPekerja) {
        super();
    ...
    public String toString() {
        ...
        sb.append(ProfilById.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdBy");
        sb.append('=');
